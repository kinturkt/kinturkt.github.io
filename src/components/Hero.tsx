        ...
        <div className="flex flex-col md:flex-row items-start gap-10 md:gap-16 animate-fade-in">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-3xl">
              I have 2+ years of experience in building scalable web applications, data science,
              machine learning models and backend development. Skilled in JavaScript, React, PHP,
              Python, and MySQL, with hands-on experience in Flask, Django RESTful APIs, Laravel, and MS Azure.
            </p>
